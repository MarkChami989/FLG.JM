                ...
                <div className="room-pc">
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                    <div className="monitor">
                      <div className="monitor-screen"><br />PC ROOM</div>
                    </div>
          ...
          <div className="card card-tourn" onClick={() => navigate('/tournaments')}>
            ...
            <div className="ticker">
              <div className="ticker-inner">
                ...
                <span className="ticker-item">Tekken League · Sat 6PM</span>
            ...
            <div className="tabletop-wrap">
              ...
              <div className="tabletop-items">
                <div className="tabletop-item" onClick={() => navigate('/pingpong')}>
                  <div className="tabletop-icon"><Icon paths={ICONS.ppIcon} width="22" height="22" /></div>
                ...
                <div className="tabletop-item" onClick={() => navigate('/billiard')}>
                  <div className="tabletop-icon"><Icon paths={ICONS.bilIcon} width="22" height="22" /></div>
                  <div className="tabletop-info">
                ...
                <div className="tabletop-item" onClick={() => navigate('/babyfoot')}>
                  <div className="tabletop-icon"><Icon paths={ICONS.bfIcon} width="22" height="22" /></div>
                  <div className="tabletop-info">
