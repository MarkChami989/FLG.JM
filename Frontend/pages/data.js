...
export const TT_SECTIONS = [
  { icon: ICONS.ppIcon, name: 'Ping Pong', color: '#06B6D4', cols: 4, items: [
  ...
  { icon: ICONS.bilIcon, name: 'Billiard', color: '#F59E0B', cols: 4, items: [
  ...
  { icon: ICONS.bfIcon, name: 'Baby Foot', color: '#D946EF', cols: 4, items: [
    { id: 'bf-t1', title: 'Table 1', glow: 'linear-gradient(90deg,#F97316,#D946EF)', iconBg: 'rgba(249,115,22,0.12)', iconBorder: 'rgba(249,115,22,0.28)', iconStroke: '#fb923c', icon: ICONS.bfIcon },
    { id: 'bf-t2', title: 'Table 2', glow: 'linear-gradient(90deg,#D946EF,#F97316)', iconBg: 'rgba(217,70,239,0.12)', iconBorder: 'rgba(217,70,239,0.28)', iconStroke: '#e879f9', icon: ICONS.bfIcon },
    { id: 'bf-t3', title: 'Table 3', glow: 'linear-gradient(90deg,#06B6D4,#D946EF)', iconBg: 'rgba(6,182,212,0.12)', iconBorder: 'rgba(6,182,212,0.28)', iconStroke: '#22d3ee', icon: ICONS.bfIcon },
    { id: 'bf-t4', title: 'Table 4', glow: 'linear-gradient(90deg,#D946EF,#06B6D4)', iconBg: 'rgba(217,70,239,0.12)', iconBorder: 'rgba(217,70,239,0.28)', iconStroke: '#e879f9', icon: ICONS.bfIcon },
  ]},
]
...
export const SECTIONS = {
  orders: { label: 'Received Orders', clr: 'var(--purple)', desc: 'Approve or reject incoming client requests across every activity.' },
  tournaments: { label: 'Tournaments', clr: 'var(--gold)', desc: 'Create, manage, and settle FIFA & Combat tournament brackets.' },
  rooms: { label: 'Rooms', clr: 'var(--cyan)', desc: 'Live occupancy across PC, PS5, and every VIP tier.' },
  lounge: { label: 'Lounge', clr: 'var(--orange)', desc: 'Bar seating and table status for the Cigar Lounge.' },
  tabletop: { label: 'Tabletop Games', clr: 'var(--pink)', desc: 'Ping Pong, Billiard & Baby Foot table oversight.' },
  support: { label: 'Support Inbox', clr: 'var(--green)', desc: 'Live AI conversations that customers escalated to staff.' },
  ...
  settings: { label: 'Settings', clr: 'var(--admin)', desc: 'Manage your login, password, and profile picture.' },
}
...
export const TOURNAMENT_ACTIONS = [
  ...
  { ic: '', t: 'Delete Tournament', d: 'Cancel an upcoming tournament and notify registered players.' },
